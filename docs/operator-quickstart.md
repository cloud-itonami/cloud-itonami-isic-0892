# Operator Quickstart — Peat Extraction Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0892** (`cloud-itonami-isic-0892`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0892.git
cd cloud-itonami-isic-0892
```
...
- Blueprint governor key: `peat-extraction-governor`
- Likely source path: `peatops.governor.cljc`
